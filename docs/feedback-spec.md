...
- 文风要像老师在具体地写某个孩子，而不是在套模板；优先直接写学生名字，例如“Eden 这次能跟上……”或“Julien 还需要在……”。
...
7. 如果作业情况值得关注，应自然融入“本节课进步”或“孩子当前待解决问题”，**不要单独设置“作业情况”板块**。
...
- 一次性的低级失误不要直接定义为新问题。
- 已明显解决的问题，应从“当前待解决问题”中移除，并在“本节课进步”中简短说明。
...
`- **<问题概括>**（本节课新增）：一句话描述问题的表现和影响`

`- **<问题概括>**（历史问题）：一句话描述问题的现状`
...
家长视角：老师有章法，下节课知道干什么。本节承接第 3 节问题的"解决方案"，要**简洁、具体、可执行**。

直接使用 bullet point，最多 5 条。每条直接写具体内容，不要先写“过去的问题”“下节课安排”之类的引导语。

例如：

- 受力图跟进：继续用短题检查 Eden 是否还会漏力；
- 做功判断：再练几道垂直力与位移的题，确认他能直接判零；
- 第二章复习：开始进入 Density 和 Pressure 的系统复习。

不需要单独设置"其他安排"或"作业要求"板块。如果作业本身值得家长知道，应在"本节课进步"或"当前待解决问题"中自然体现。
