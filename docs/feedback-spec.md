...
用一句简短的话说明哪些老问题还在持续跟踪。不要写成详细的问题清单。

### 下节课安排：

直接使用 bullet point，最多 5 条。每条要么是针对第 3 节某个问题的解决方案（练什么 / 怎么练 / 怎么检查），要么是具体的教学安排。

例如：

- 重做受力分析作业（4 道同类型题），画图前先列"物体清单"，下节课检查是否还有漏力；
- 做题前先圈出题目里的单位，所有答案必须带单位提交；
- 完成 Energy 章节剩余内容。
